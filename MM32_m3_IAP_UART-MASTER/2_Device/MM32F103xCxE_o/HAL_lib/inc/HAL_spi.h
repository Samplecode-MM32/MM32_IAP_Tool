...
((IT) == SPI_IT_RX) || ((IT) == SPI_IT_UNDERRUN) || ((IT) == SPI_IT_RXOERR) || \
((IT) == SPI_IT_RXMATCH) || ((IT) == SPI_IT_RXFULL) || ((IT) == SPI_IT_TXEPT))
...
* @{
*/
#define SPI_FLAG_RXAVL_4BYTE          ((uint16_t)0x0008)
...
((FLAG) == SPI_FLAG_TXEPT) || ((FLAG) == SPI_FLAG_TXFULL) || \
((FLAG) == SPI_FLAG_RXAVL_4BYTE))
