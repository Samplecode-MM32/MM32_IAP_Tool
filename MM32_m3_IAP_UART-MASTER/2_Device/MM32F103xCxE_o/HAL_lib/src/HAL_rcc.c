...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
    ...
    {
        RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000008, 0x00000001);//Frclk*9/2
    }
    if(RCC_PLLMul==RCC_PLLMul_18)
    {
        RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000003, 0x00000002);//Frclk*4/3
    }
}
...
*   This parameter can be one of the following values:
* @arg RCC_USBCLKSource_PLLCLK_Div1: PLL selected as USB clock source
* @arg RCC_USBCLKSource_PLLCLK_Div2: PLL/2 selected as USB clock source
* @arg RCC_USBCLKSource_PLLCLK_Div3: PLL/3 selected as USB clock source
* @arg RCC_USBCLKSource_PLLCLK_Div4: PLL/4 selected as USB clock source
* @retval : None
*/
...
/**
* @brief  Configures the QSPI clock (USBCLK).
* @param RCC_USBCLKSource: specifies the QSPI clock source. This clock is 
*                          derived from the PLL output.
*   This parameter can be one of the following values:
* @arg RCC_USBCLKSource_PLLCLK_Div1: PLL selected as QSPI clock source
* @arg RCC_USBCLKSource_PLLCLK_Div2: PLL/2 selected as QSPI clock source
* @arg RCC_USBCLKSource_PLLCLK_Div3: PLL/3 selected as QSPI clock source
* @arg RCC_USBCLKSource_PLLCLK_Div4: PLL/4 selected as QSPI clock source
* @retval : None
*/
void RCC_QSPICLKConfig(uint32_t RCC_QSPICLKSource)
{
    /* Check the parameters */
    assert_param(IS_RCC_QSPICLK_SOURCE(RCC_QSPICLKSource));
    RCC->SYSCFGR |= RCC_QSPICLKSource;
}
...
*   This parameter can be any combination of the following values:
* @arg RCC_AHB3Periph_FSMC
* @arg RCC_AHB3Periph_QSPI
...
{
    /* Check the parameters */
    assert_param(IS_RCC_AHB1_PERIPH(RCC_AHB3Periph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    if (NewState != DISABLE)
    {
...
*   This parameter can be any combination of the following values:
* @arg RCC_AHB2Periph_AES
* @arg RCC_AHB2Periph_RNG
* @arg RCC_AHB2Periph_OTGFS
*   SRAM and FLITF clock can be disabled only during sleep mode.
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
...
{
    /* Check the parameters */
    assert_param(IS_RCC_AHB1_PERIPH(RCC_AHB2Periph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    if (NewState != DISABLE)
    {
...
*   This parameter can be any combination of the following values:
* @arg RCC_AHB1Periph_GPIOA
* @arg RCC_AHB1Periph_GPIOB
* @arg RCC_AHB1Periph_GPIOC
* @arg RCC_AHB1Periph_GPIOD
* @arg RCC_AHB1Periph_SDIO
* @arg RCC_AHB1Periph_CRC
* @arg RCC_AHB1Periph_FLASH
* @arg RCC_AHB1Periph_SRAM
* @arg RCC_AHB1Periph_DMA1
* @arg RCC_AHB1Periph_DMA2
* @arg RCC_AHB1Periph_ETHMAC
*   SRAM and FLITF clock can be disabled only during sleep mode.
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
...
*   clock.
*   This parameter can be any combination of the following values:
* @arg  RCC_APB2Periph_TIM1, RCC_APB2Periph_TIM8,
*    RCC_APB2Periph_UART1, RCC_APB2Periph_UART6, RCC_APB2Periph_ADC1,
*    RCC_APB2Periph_SPI1, RCC_APB2Periph_SYSCFG, RCC_APB2Periph_COMP,
*    RCC_APB2Periph_ALL
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
...
*   RCC_APB1Periph_CRS, RCC_APB1Periph_CAN1, RCC_APB1Periph_BKP,
*   RCC_APB1Periph_PWR, RCC_APB1Periph_UART7, RCC_APB1Periph_UART8
*   RCC_APB1Periph_ALL
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
...
*   This parameter can be any combination of the following values:
* @arg  RCC_AHB3Periph_FSMC, RCC_AHB3Periph_QSPI
*    RCC_AHB3Periph_ALL
...
*   This parameter can be any combination of the following values:
* @arg  RCC_AHB2Periph_AES, RCC_AHB2Periph_RNG,
*    RCC_AHB2Periph_OTGFS, RCC_AHB2Periph_ALL
* @param NewState: new state of the specified peripheral reset.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
*/
...
{
    /* Check the parameters */
    assert_param(IS_RCC_AHB3_PERIPH(RCC_AHB2Periph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    if (NewState != DISABLE)
    {
...
*   This parameter can be any combination of the following values:
* @arg  RCC_AHB1Periph_GPIOA, RCC_AHB1Periph_GPIOB,
*    RCC_AHB1Periph_GPIOC, RCC_AHB1Periph_GPIOD, RCC_AHB1Periph_GPIOE,
*    RCC_AHB1Periph_SDIO, RCC_AHB1Periph_CRC, RCC_AHB1Periph_FLASH,
*    RCC_AHB1Periph_SRAM, RCC_AHB1Periph_DMA1, RCC_AHB1Periph_DMA2,
*    RCC_AHB1Periph_ETHMAC, RCC_AHB1Periph_ALL
* @param NewState: new state of the specified peripheral reset.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
*/
...
{
    /* Check the parameters */
    assert_param(IS_RCC_AHB3_PERIPH(RCC_AHB1Periph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    if (NewState != DISABLE)
    {
