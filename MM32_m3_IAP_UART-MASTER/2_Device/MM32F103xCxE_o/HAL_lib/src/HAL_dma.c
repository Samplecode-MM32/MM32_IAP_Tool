...
#define DMA2_Channel6_IT_Mask    ((uint32_t)0x00F00000)
#define DMA2_Channel7_IT_Mask    ((uint32_t)0x0F000000)
...
void DMA_DeInit(DMA_Channel_TypeDef* DMAy_Channelx)
{
    ...
    case DMA1_Channel5_BASE:
        ...
        /* Reset interrupt pending bits for DMA1 Channel1 */
        DMA1->IFCR |= DMA2_Channel1_IT_Mask;
        break;
    case DMA2_Channel2_BASE:
        /* Reset interrupt pending bits for DMA1 Channel2 */
        DMA1->IFCR |= DMA2_Channel2_IT_Mask;
        break;
    case DMA2_Channel3_BASE:
        /* Reset interrupt pending bits for DMA1 Channel3 */
        DMA1->IFCR |= DMA2_Channel3_IT_Mask;
        break;
    case DMA2_Channel4_BASE:
        /* Reset interrupt pending bits for DMA1 Channel4 */
        DMA1->IFCR |= DMA2_Channel4_IT_Mask;
        break;
    case DMA2_Channel5_BASE:
        /* Reset interrupt pending bits for DMA1 Channel5 */
        DMA1->IFCR |= DMA2_Channel5_IT_Mask;
        break;		
