...
#define IC_TAR_ENDUAL_Set        ((uint16_t)0x0800)
#define IC_TAR_ENDUAL_Reset      ((uint16_t)0xF7FF)

/* I2C SPECIAL、GC_OR_START bits mask */
#define IC_TAR_GC_Set            ((uint16_t)0x0400)
#define IC_TAR_GC_Reset          ((uint16_t)0xFBFF)
...
void I2C_GenerateSTOP1(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
    u8 tempReg=0;
    tempReg=tempReg;
    //  /* Check the parameters */
